exports('LoadAnimDict', PLLib.Wrap('LoadAnimDict', function(dict)
    RequestAnimDict(dict)
    while not HasAnimDictLoaded(dict) do Wait(10) end
end))

-- blendIn/blendOut/duration/flags match TaskPlayAnim defaults used across pl_uwucafe
exports('PlayAnim', PLLib.Wrap('PlayAnim', function(entity, dict, anim, blendIn, blendOut, duration, flags)
    TaskPlayAnim(
        entity, dict, anim,
        blendIn  or 8.0,
        blendOut or -8.0,
...
exports('LookAt', PLLib.Wrap('LookAt', function(coords)
